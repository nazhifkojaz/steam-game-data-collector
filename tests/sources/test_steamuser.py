...
from steamgamedata.sources import steamuser
...
class TestSteamUser():
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("usersummary_success_response_open_profile", {"steamid": "12345", "community_visibility_state":3, "time_created": 123456789}),
            ("usersummary_success_response_closed_profile", {"steamid": "12345", "community_visibility_state":1, "time_created": None}),
        ],
    )
    def test_fetch_summary_success(
        ...
        assert result["data"]["community_visibility_state"] == expected_result["community_visibility_state"]
    ...
    def test_fetch_summary_steamid_not_found(
        self,
        mock_request_response,
        usersummary_not_found_response_data
    ):
        mock_request_response(
            target_class=SteamUser,
            json_data=usersummary_not_found_response_data
        )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("owned_games_exclude_free_response", False, {"success": True, "game_count": 2, "data_len": 2, "is_free_game_exist": False}),
            ("owned_games_include_free_response", True, {"success": True, "game_count": 3, "data_len": 2, "is_free_game_exist": True}),
            ("owned_games_no_games_owned", True, {"success": True, "game_count": 0, "data_len": 2, "is_free_game_exist": False}),
            ("owned_games_only_own_free_games", True, {"success": True, "game_count": 1, "data_len": 2, "is_free_game_exist": True})
        ]
    )
    def test_fetch_owned_games_success(
        ...
        source = SteamUser(api_key="mockapikey")
        result = source._fetch_owned_games(steamid="12345", verbose=False, include_free_games=include_free)
        ...
        assert any(game["appid"] == 570 for game in result["data"]["games"]) is expected_result["is_free_game_exist"]
    ...
    @pytest.mark.parametrize(
        "steamresponse_data, expected_result",
        [
            ("recently_played_games_active_player_response_data", {"success": True, "games_count": 2, "total_playtime_2weeks":13}),
            ("recently_played_games_inactive_player_response_data", {"success": True, "games_count": 0, "total_playtime_2weeks":0}),
        ]
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                {"community_visibility_state": 1, "has_owned_games": False, "has_recently_played_games": False}
            ),
            (
                ["usersummary_success_response_open_profile", "owned_games_no_games_owned", "recently_played_games_inactive_player_response_data"],
                {"community_visibility_state": 3, "has_owned_games": False, "has_recently_played_games": False},
            ),
            (
                ["usersummary_success_response_open_profile", "owned_games_only_own_free_games", "recently_played_games_free_player_response_data"],
                {"community_visibility_state": 3, "has_owned_games": True, "has_recently_played_games": True},
            ),
            (
                ["usersummary_success_response_open_profile", "owned_games_exclude_free_response", "recently_played_games_inactive_player_response_data"],
                {"community_visibility_state": 3, "has_owned_games": True, "has_recently_played_games": False}
            ),
            (
                ["usersummary_success_response_open_profile", "owned_games_exclude_free_response", "recently_played_games_active_player_response_data"],
                {"community_visibility_state": 3, "has_owned_games": True, "has_recently_played_games": True},
            ),
        ],
        ids=[
    ...
    def test_fetch_success(
        ...
        assert result["success"] is True
        assert result["data"]["community_visibility_state"] == expected_result["community_visibility_state"]
        assert True if result["data"]["owned_games"] else False == expected_result["has_owned_games"]
        assert True if result["data"]["recently_played_games"] else False == expected_result["has_recently_played_games"]
    ...
    def test_fetch_error_no_api_key(
        self
    ):
        source = SteamUser()
        result = source.fetch(steamid="12345")
